...
|---|---|---|---|---|
| offline suite (`redteam/crazy-testing` branch, post-auto-tag) | **588 pass / 1 skip / 2 xfail** (= 569 Stage-10 baseline + **11** DN-QA50 PR-1/PR-2 + **8** auto-tag tests in `tests/test_tagging.py`; all 580 prior **byte-identical**, 0 regressions). NB: branch ≠ main/Stage-8's 373 — the branch adds the red-team layer + Stage 10 + DN-QA50 + auto-tag | `make test` | 2026-06-28 | bb1058d |
